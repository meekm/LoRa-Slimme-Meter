...
// pin mappings
#if defined(ARDUINO_TTGO_LoRa32_V1) || defined(T_BEAM)
// define IO pins TTGO LoRa32 V1 or T_BEAM
...
extern void loraSetTxComplete( void (*txComplete)(bool)) {
  txCompleteCallback = txComplete;
}
